...
#   Consultamos si estu1 es instancia de estudiante
print(isinstance(estu1, Estudiante))  #  Estu1 es una instancia de la clase estudiante
print(isinstance(estu1, Persona))  # Estu1 es una instancia de la clase padre Persona

per1 = Persona("Torres", "Lopez", "Juan")
print(
    isinstance(per1, Estudiante)
)  #   Da false porque Persona es la clase padre de estudiante, entonces no es una instancia
